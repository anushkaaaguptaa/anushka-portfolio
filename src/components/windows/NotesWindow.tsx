...
export const NotesWindow: React.FC = () => {
  ...
  const sidebarItems: Array<{ id: NotesSectionId; label: string; icon: string; snippet: string }> = [
    ...
    },
    {
      ...
      label: '💼 experience',
      icon: '💼',
      snippet: 'Developed an audio processing and self-supervised contrastive learning pipeline...',
    },
    {
      id: 'achievements',
      label: '🏆 little wins',
      icon: '🏆',
      snippet: "I've always been the kind of person who gets a little too excited about learning...",
    },
    {
      id: 'projects',
      label: '🛠️ projects',
      icon: '🛠️',
      snippet: 'ResuMate: smart resume parsing, ATS scoring, and automated internship recommendations.',
    },
    {
      id: 'hackathons',
      label: '👩‍💻 hackathons',
    ...
    },
    {
      ...
      label: '💬 hit me up',
      icon: '💬',
      snippet: "i genuinely like talking to people — hearing perspectives i haven't considered...",
    },
  ];
  ...
  return (
    <WindowFrame id="notes" headerTitle="Notes — Anushka Portfolio">
      <div className="flex h-full w-full overflow-hidden text-sm">
        ...
        <div ref={contentRef} className="flex-1 overflow-y-auto bg-slate-950/70 p-6 md:p-8 scrollbar-thin">
          {/* SECTION 1: ABOUT ME */}
          {activeSection === 'about' && (
